...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Search Website</li>
        </ol>
    </nav>
</div>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('search-websites.update', $website->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="search_url_node" autocomplete="off" placeholder="Website Search URL" name="search_url_node" value="{{$website->search_url_node}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="product_image_node" autocomplete="off" placeholder="Product Image" name="product_image_node" value="{{$website->product_image_node}}">
                    </div>
                    <div class="form-group">
                        <label for="role_name">Product Link</label>
                        <input type="text" class="form-control" id="product_link_node" autocomplete="off" placeholder="Product Link" name="product_link_node" value="{{$website->product_link_node}}">
                    </div>
