            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('blog.store') }}"
                    ...
                    {{-- <div class="form-group">
                        ...
                        <div class="form-group">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table-data">
                                ...
                                <tr class="tr_clone">
                                    ...
                                    <td><input type="number" autofocus placeholder="Quantity" name="quantity[]" ></td>
                        ...
                        <div class="form-group">
                            <label for="title">Preparation Time</label>
                            <input type="text" class="form-control without" placeholder="0:15"  autocomplete="off" name="preparation_time">
                        </div>

                        <div class="form-group">
                            <label for="title">Cooking Time</label>
                            <input type="text" class="form-control"  autocomplete="off" placeholder="1:25" name="cooking_time">
                        </div>
