...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <a href="{{ route('brands.create') }}" class="btn btn-primary btn-icon-text">
    ...
    <div class="col-md-12 grid-margin stretch-card">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">All the brands are listed here.</p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('brands.edit',$brand->id) }}" class="btn btn-warning btn-icon-text">
