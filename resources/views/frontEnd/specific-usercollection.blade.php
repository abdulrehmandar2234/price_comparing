...
@section('content')
        ...
        <div class="container">
            <div class="my-6">
                <h1 class="text-center">{{ $collections->name }}</h1>
                {{-- {{ dd($collections->id) }} --}}
                <a class="text-center btn btn-primary text-white" href="{{ route('collection.edit', $collections->id) }}">Edit Collection Name</a>
                        ...
                        <table class="table" cellspacing="0">
                           ...
                           <tr class="">
                            ...
                            <td class="d-none d-md-table-cell">
                                <a href="#"><img class="img-fluid max-width-100 p-1 border border-color-1" src="{{asset('products/'.$c['stores'][0]['image'])}}" alt="Image Description"></a>
                            </td>

                            <td data-title="Product">
                                <a href="#" class="text-gray-90">{{$c['name']}}</a>
                            </td>

                            <td data-title="Price">
                                <span class="">{{$c['stores'][0]['price']}}</span>
                            </td>

                            {{-- <td data-title="Price">
                                <span class="">{{$c['stores'][0]['unit_price']}}</span>
                            </td> --}}
                            ...
                            <td>
                                <img data-title="Logo"
                                src="{{ url('products/'.$c['stores'][0]['website_logo'])}}"
                                alt="Image Description" height="15px" width="15px">
                            </td>
