                ...
                <div class="row">
                    ...
                    {{-- <div class="col-md-5 ml-xl-auto mr-md-auto mr-xl-0 mb-8 mb-md-0">
                        ...
                        <form class="js-validate" novalidate="novalidate" action="{{ route('login') }}" method="POST">
                            ...
                            <!-- Form Group -->
                            <div class="js-form-message f`m-group">
                            ...
                            <!-- End Button -->
                            <a href="login/google" class="btn btn-primary mt-4 w-100 border-light lift"> <img src="https://img.icons8.com/color/16/000000/google-logo.png" alt="" class="mr-3">{{ __('Continue with Google') }}</a>
                            <br> <br>
                            <a href="login/facebook" class="btn btn-primary mt-4 w-100 border-light lift"> <img src="assets\img\facebook-logo.png" alt="" height="20px" width="20px" class="mr-3">{{ __('Continue with Facebook') }}</a>
                    ...
                    <div class="col-lg-9 ">
                        ...
                        <!-- End Title -->
                        <form class="js-validate" novalidate="novalidate" action="{{ route('profile.update') }}" method="POST">
                            @csrf
                            @method('POST')
                            <!-- Form Group -->
                            <div class="js-form-message form-group">
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <input type="email" class="form-control" name="email" placeholder="Email address" value="{{ Auth::user()->email }}">
                            </div>
                            <!-- End Form Group -->
                            <!-- Button -->
                            <div class="mb-1">
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-primary-dark-w px-5 text-white">Update Profile</button>
                                </div>
                            </div>
                            <!-- End Button -->
                        </form>
                        ...
                        <form class="js-validate" novalidate="novalidate" action="{{ route('change.password') }}" method="POST">
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <input type="password" class="form-control" name="new-password" id="signinSrPasswordExample2" placeholder="New Password" aria-label="Password" required data-msg="Your password is invalid. Please try again." data-error-class="u-has-error" data-success-class="u-has-success">
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <input type="password" class="form-control" name="new-password-confirmed" id="signinSrPasswordExample2" placeholder="Confirm Password" aria-label="Confirm Password" required data-msg="Your password is invalid. Please try again." data-error-class="u-has-error" data-success-class="u-has-success">
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="mb-1">
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-primary-dark-w px-5 text-white">Updated Password</button>
                                </div>
                            </div>
                            <!-- End Button -->
