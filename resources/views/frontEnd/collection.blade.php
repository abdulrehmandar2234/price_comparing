        ...
        <div class="container">
            <div class="my-6">
                ...
                <input type="hidden" id="hiddenqty" name="quantity">
                    ...
                    <button type="submit" class="btn btn-primary" id="getqty"> Save </button>
                        ...
                        <table class="table" cellspacing="0">
                           ...
                           <tr class="">
                            ...
                            <td class="d-none d-md-table-cell">
                                <a href="#"><img class="img-fluid max-width-100 p-1 border border-color-1" src="{{asset('product/'.$c['stores'][0]['image'])}}" alt="Image Description"></a>
                            </td>
