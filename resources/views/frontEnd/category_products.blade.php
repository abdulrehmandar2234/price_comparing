            ...
            success: function (data) {
                ...
                for (var i = 0; i < stores.length; i++) {
                    ...
                    stores_html += `<li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                                                <div class="col-auto">
                                                                    <a href="" class="d-block width-75 text-center"><img class="img-fluid" src="${window.location.origin + '/product/' + stores[i]['website_logo']}" alt="Image Description" height="40px" width="40px"></a>
                                                                </div>
                ...
                console.log(window.location.origin + '/product/' + image)
                $('.modal_image').attr('src', window.location.origin + '/product/' + image);
            }
        });
